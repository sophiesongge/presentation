...
\begin{frame}
\frametitle{Parallel Workflow --- Survey}
\begin{center}
...
\item[-] Find restaurant for moving users
\end{itemize}
...
\textbf{n tasks for each generation: }partition the new data items without re-partition the old ones.
\vspace{-0.2in}
