...
\begin{itemize}
\item \textbf{Architecture Level: } possible to add or remove computational nodes based on the current load

\item \textbf{Application Level: } able to withdraw old results and take new coming data into account
\end{itemize}
\end{frame}
